...
<div class="nav-tabs-wrapper">
    <ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#booked" role="tab">Pesanan</a>
    </li>
    ...
    <table border="1" align = "center">
                    ...
                    <tbody>
                        ...
                        <tr align = "center"><td><?php echo $i; $i+=1?></td>
                            <td><?php echo $keluar['user']; ?></td>
                            <td><?php echo $keluar['tiket']; ?></td>
                            <td><?php echo $keluar['status']; ?></td>
                            <?php
                            if ($keluar['status'] == 'Proses'){ ?>
                                <td><a  class="btn btn-primary" href="<?php echo base_url('index.php/Pesanan/Valid/'.$keluar['id']); ?>">Valid</a> | <a class="btn btn-primary" href="<?php echo base_url('index.php/Pesanan/Batal/'.$keluar['id']); ?>">Batal</a></td>
                            <?php } else{?>
                                <td><a class="btn btn-primary" href="<?php echo base_url('index.php/Pesanan/Hapus/'.$keluar['id']); ?>">Hapus</a> </td>
                            <?php } ?>
                        </tr>
                            <?php } ?>
                    </tbody>
