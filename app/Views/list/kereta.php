    ...
    <div class="tab-pane fade show active" id="4a">
        ...
        <div class="tm-recommended-place-wrap">
            <div class="tm-recommended-place">
                <img src="/img/trans/aekloba.jpg" alt="Image" class="img-fluid tm-recommended-img">
                <div class="tm-recommended-description-box">
                    <div class="text-center">
                    <h3 class="tm-recommended-title">Aekloba</h3>
                    </div>
            ...
            <div class="tm-recommended-place">
                <img src="/img/trans/ancol.jpg" alt="Image" class="img-fluid tm-recommended-img">
                <div class="tm-recommended-description-box">
                    <div class="text-center">
                    <h3 class="tm-recommended-title">Ancol</h3>
                    </div>
            ...
            <div class="tm-recommended-place">
                <img src="/img/trans/bekri.jpg" alt="Image" class="img-fluid tm-recommended-img">
                <div class="tm-recommended-description-box">
                    <div class="text-center">
                    <h3 class="tm-recommended-title">Bekri</h3>
                    </div>
...
<div class="tab-content clearfix">           	
       ...
       <div class="tab-pane fade show active" id="4a">
            <div class="tm-recommended-place-wrap">
                ...
                <div class="tm-recommended-place">
                    <img src="/img/<?= $tr['foto_kereta']; ?>" alt="Image" class="img-fluid tm-recommended-img">
                    <div class="tm-recommended-description-box">
                        <div class="text-center">
                        <h3 class="tm-recommended-title"><?= $tr['nama_kereta']; ?></h3>
                        </div>
                    ...
                    <a href="#" class="tm-recommended-price-box">
                        ...
                        <p class="tm-recommended-price-link">Pesan!</p>
                        <p href="/.../<?= $tr['nama_kereta']; ?>" class="btn btn-primary">Ubah Data</p>
                    </a>                        
                </div>
                <?php endforeach; ?>
                <?php endforeach; ?>
