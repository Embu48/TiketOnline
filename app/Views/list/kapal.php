    ...
    <div class="tab-pane fade show active" id="4a">
        ...
        <div class="tm-recommended-place-wrap">
            <div class="tm-recommended-place">
                <img src="/img/trans/merak.jpg" alt="Image" class="img-fluid tm-recommended-img">
                <div class="tm-recommended-description-box">
                    <div class="text-center">
                    <h3 class="tm-recommended-title">Pelabuhan Merak</h3>
                    </div>
            ...
            <div class="tm-recommended-place">
                <img src="/img/trans/periuk.jpg" alt="Image" class="img-fluid tm-recommended-img">
                <div class="tm-recommended-description-box">
                    <div class="text-center">
                    <h3 class="tm-recommended-title">Pelabuhan Tanjung Periuk</h3>
                    </div>
...
<div class="tab-content clearfix">           	
    ...
    <div class="tab-pane fade show active" id="4a">
            <div class="tm-recommended-place-wrap">
                ...
                <div class="tm-recommended-place">
                    <img src="/img/<?= $tr['foto_kapal']; ?>" alt="Image" class="img-fluid tm-recommended-img">
                    <div class="tm-recommended-description-box">
                        <div class="text-center">
                        <h3 class="tm-recommended-title"><?= $tr['nama_kapal']; ?></h3>
                        </div>
                    ...
                    <a href="#" class="tm-recommended-price-box">
                        ...
                        <p class="tm-recommended-price-link">Pesan!</p>
                        <p href="/.../<?= $tr['nama_kapal']; ?>" class="btn btn-primary">Ubah Data</p>
                    </a>                        
                </div>
                <?php endforeach; ?>
                <?php endforeach; ?>
